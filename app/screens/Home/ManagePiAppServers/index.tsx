...
//Params
type Props = NativeStackScreenProps<LoggedInTabNavigatorParams, 'ManagePiAppServers'>;

const ManagePiAppServers = ({ navigation, route }: Props) => {
  //Refs
...
export default ManagePiAppServers;
