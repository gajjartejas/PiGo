...
const GITHUB_PROJECT_LINK = 'https://github.com/gajjartejas/PiGo';

const Constant = {
  APP_STORE_URL: 'market://details?id=com.tejasgajjar.pigo',
  PLAY_STORE_URL: 'https://play.google.com/store/apps/details?id=com.tejasgajjar.pigo',
